defmodule IdenticonTest do
  ...
  test "banana color" do
    assert Identicon.pick_color(%Identicon.Image{hex: [114, 179, 2, 191, 41, 122, 34, 138, 117, 115, 1, 35, 239, 239, 124, 65]}) == [114, 179,2]
  end
  ...
  test "transistor color" do
    assert Identicon.pick_color(%Identicon.Image{hex: [170, 160, 215, 138, 244, 154, 47, 188, 47, 122, 216, 251, 177, 29, 225, 170]}) == [170, 160, 215]
  end
end
